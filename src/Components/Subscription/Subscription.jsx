...
const Subscription = () => {
  ...
  useEffect(
    () => {
      ...
      //      1   document.body.style.overflow = "";: Сбрасывает стиль overflow на значение по умолчанию, снова позволяя прокрутку страницы.
      //      2   document.body.style.paddingRight = "";: Сбрасывает правый отступ, восстанавливая исходный вид страницы.
    },
